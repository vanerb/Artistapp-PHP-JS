...
$query = "SELECT eventos.*, usuarios.usuario FROM eventos JOIN usuarios ON eventos.id_usuario = usuarios.id ORDER BY eventos.fecha_fin DESC LIMIT $limit OFFSET $offset";
