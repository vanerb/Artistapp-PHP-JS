...
$query = "SELECT productos.*, tipo_producto.nombre AS tipo, usuarios.usuario FROM productos JOIN tipo_producto ON productos.id_tipo = tipo_producto.id JOIN usuarios ON productos.id_usuario = usuarios.id LIMIT $limit OFFSET $offset";
